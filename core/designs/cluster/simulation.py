"""
Simulation-based methods for cluster randomized controlled trials.

This module provides functions for power analysis and sample size calculation
for cluster randomized controlled trials using simulation-based approaches.
"""
import numpy as np
from scipy import stats


def simulate_continuous(n_clusters, cluster_size, icc, mean1, mean2, 
...
def simulate_binary(n_clusters, cluster_size, icc, p1, p2, 
